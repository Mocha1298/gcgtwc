            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <a href="/newuser" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3">
                            <i class="btn-inner">
                    ...
                    @if (session('cek') == 'sukses')
                        <div class="alert alert-success" role="alert">
                            <strong>Sukses Simpan</strong>
                        </div>
                    @elseif (session('cek') == 'edit')
                        <div class="alert alert-warning" role="alert">
                            <strong>Sukses Edit</strong>
                        </div>
                    @elseif (session('cek') == 'hapus')
                        <div class="alert alert-danger" role="alert">
                            <strong>Sukses Hapus</strong>
                        </div>
                    @endif
