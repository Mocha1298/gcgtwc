                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">List Indikator</h4>
                            </div>
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="text"
                                                    aria-describedby="text" placeholder="Nama Indikator">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="text"
                                                    aria-describedby="text" placeholder="Bobot">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    <a class="btn btn-sm btn-icon text-info" data-bs-toggle="tooltip"
                                                        data-bs-placement="top" title="Detail" href="/parameter">
