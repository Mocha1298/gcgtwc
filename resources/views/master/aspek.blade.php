...
@section('greeting')
    <h1>Aspek <span class="tahun">({{$tahun}})</span></h1>
@endsection
...
@section('script')
    ...
    <script>
        function cari() {
            ...
            window.location.href = '/aspek/' + tahun;
        }
    </script>
@endsection
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="/aspek/{{$tahun}}" method="post">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="text" class="form-label">Nama Aspek</label>
                                                    <input type="text" class="form-control" id="text"
                                                        aria-describedby="text" placeholder="Nama Aspek" name="nama"
                                                        required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="text" class="form-label">Bobot</label>
                                                    <input type="text" class="form-control" id="text"
                                                        aria-describedby="text" placeholder="Bobot" name="bobot" required>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    ...
                                                    <a class="btn btn-sm btn-icon" data-bs-toggle="tooltip"
                                                        href="/edit/aspek/{{ $item->id }}" aria-label="Edit"
                                                    ...
                                                    <a class="btn btn-sm btn-icon text-danger " data-bs-toggle="tooltip"
                                                        onclick="hapus('aspek',{{ $item->id }})" aria-label="Delete"
