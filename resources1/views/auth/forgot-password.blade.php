                        ...
                        <div class="col-md-6">
                            <div class="card d-flex justify-content-center mb-0 auth-card">
                                <div class="card-body">
                                    ...
                                    <p style="font-size: 15px" class="text-center">Silahkan masukkan email Anda untuk kami mengirim link reset password.</p>
                                    <form method="POST" action="{{ route('password.email') }}" style="font-size: 13px">
                                        <div class="row">
                                            @csrf
                                            <div class="col-lg-12">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <button style="border:none;background: #00A7E6" type="submit" class="btn btn-primary">Kirim</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
