        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    {{-- <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-table1" role="button" aria-expanded="false" aria-controls="sidebar-table">
                            <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                        ...
                        <ul class="sub-nav collapse" id="sidebar-table1" data-bs-parent="#sidebar-menu">
                            @foreach ($aspek as $aspeks)
                                <li class="nav-item">
                                    <a class="nav-link " href="/aspek/{{$aspeks->id}}/{{date('Y')}}">
                                        <i class="icon">
                                        ...
                                        <i class="sidenav-mini-icon"> {{ $romawi[$aspeks->urutan - 1] }} </i>
                                        <span class="item-name">Aspek {{ $romawi[$aspeks->urutan - 1] }}</span>
                                    </a>
                                </li>
                            @endforeach
                        </ul>
        ...
        <div class="position-relative iq-banner mb-4">
            ...
            <div class="iq-navbar-header" style="height: 215px;">
                <div class="container-fluid iq-container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center" style="color: #00A7E6;">
                ...
                <div class="iq-header-img">
                    <img src="/BANNER GCG.png" alt="header"
        ...
        <footer class="footer">
            <div class="footer-body">
                ...
                <div class="right-panel">
                    ...
                    </script>PT Taman Wisata Candi Borobudur, Prambanan dan Ratu Boko<a href="https://twc.id/"></a>.
                </div>
            </div>
        </footer>
        <!-- Footer Section End -->
